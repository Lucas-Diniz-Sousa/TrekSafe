...
export const createStyles = (isDarkMode) => StyleSheet.create({
  ...
  inputWrapper: {
    ...
    borderWidth: 1.5,
    borderColor: ColorUtils.getThemeColor(Colors.inputBorder, Colors.borderDark, isDarkMode),
    borderRadius: 12,
  ...
  textInput: {
    flex: 1,
    fontSize: 16,
    color: ColorUtils.getThemeColor(Colors.inputText, Colors.inputTextDark, isDarkMode),
    fontFamily: Fonts.body,
  },
  passwordToggle: {
    padding: 4,
  ...
  loginButtonDisabled: {
    backgroundColor: ColorUtils.getThemeColor(Colors.gray300, Colors.gray600, isDarkMode),
    elevation: 0,
    shadowOpacity: 0,
  },
  loginButtonText: {
