...
class TrailService {
  ...
  /**
   * Buscar trilhas por bounding box (�rea do mapa)
   * @param {Object} boundingBox - Coordenadas da �rea
  ...
  static async searchTrailsByArea(boundingBox, includePois = false) {
    try {
      ...
      console.error('Erro ao buscar trilhas por �rea:', error);
      throw error;
    }
  }
   ...
   * @returns {Promise<Object>} Resposta da API com trilhas do usu�rio
   */
  ...
  /**
   * Calcular bounding box baseado na regi�o atual do mapa
   * @param {Object} region - Regi�o do mapa
  ...
  /**
   * Formatar coordenadas para envio � API
   ...
   * @param {Object} trailInfo - Informa��es da trilha
  ...
  /**
   * Calcular dist�ncia total da trilha
   * @param {Array} coordinates - Array de coordenadas
   * @returns {number} Dist�ncia total em metros
   */
  ...
  /**
   * Calcular dura��o da trilha
   * @param {Date} startTime - Hora de in�cio
   * @param {Date} endTime - Hora de fim
   * @returns {number} Dura��o em segundos
   */
