...
/**
 * Servi�o de armazenamento seguro para tokens e dados sens�veis
 */
class SecureStorage {
  ...
  /**
   * Verifica se a autentica��o biom�trica est� habilitada
   * @returns {Promise<boolean>} True se habilitada, false caso contr�rio
   */
  ...
  /**
   * Define se a autentica��o biom�trica est� habilitada
  ...
  /**
   * Obt�m o tipo de biometria suportada
  ...
  /**
   * Remove todos os tokens e dados de autentica��o
   */
  static async clearAuthData() {
    try {
      ...
      console.error('Erro ao limpar dados de autentica��o:', error);
      throw error;
    }
  }
  ...
  /**
   * Verifica se o usu�rio est� autenticado (possui tokens v�lidos)
  ...
  /**
   * Armazena tokens de autentica��o
